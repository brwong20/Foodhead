...
- (void)viewDidLoad {
    ...
    self.searchView = [[BRWSearchView alloc]initWithFrame:CGRectMake(self.view.frame.size.width/2 - self.view.frame.size.width * 0.45, self.view.frame.size.height * 0.05, self.view.frame.size.width * 0.9, 50.0)];
...
- (void)submitReview{
    if (self.currentReview.restaurant_id) {
        ...
        //Warn user to select restaurant - disable send
    }
}
