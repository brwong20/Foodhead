...
{
    [self togglePlayPause];
    [_delegate didTapPlayBackButton:node withState:self.playerState];
}
...
- (void)hideControlsAnimated:(BOOL)animated{
    if (animated) {
        [UIView animateWithDuration:0.25 animations:^{
            _playbackButtonNode.alpha = 0.0;
            _fullScreenButtonNode.alpha = 0.0;
            _elapsedTextNode.alpha = 0.0;
            _durationTextNode.alpha = 0.0;
            _scrubberNode.alpha = 0.0;
        }completion:nil];
    }else{
        _playbackButtonNode.alpha = 0.0;
        _fullScreenButtonNode.alpha = 0.0;
...
- (void)showControlsAnimated:(BOOL)animated{
    if (animated) {
        [UIView animateWithDuration:0.25 animations:^{
            _playbackButtonNode.alpha = 1.0;
            _fullScreenButtonNode.alpha = 1.0;
            _elapsedTextNode.alpha = 1.0;
            _durationTextNode.alpha = 1.0;
            _scrubberNode.alpha = 1.0;
        }completion:nil];
    }else{
        _playbackButtonNode.alpha = 1.0;
        _fullScreenButtonNode.alpha = 1.0;
...
- (ASLayoutSpec *)defaultLayoutSpecThatFits:(CGSize)maxSize
{
  ...
  UIEdgeInsets insets = UIEdgeInsetsMake(0.0, 10.0, 0.0, 10.0);
