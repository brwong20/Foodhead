...
- (void)setupUI{
    ...
    self.promptContainer.layer.borderColor = UIColorFromRGB(0xA4AAB3).CGColor;
    ...
    self.feedbackView.layer.borderColor = UIColorFromRGB(0xA4AAB3).CGColor;
    ...
    self.submitButton.backgroundColor = APPLICATION_BLUE_COLOR;
    self.submitButton.layer.cornerRadius = self.submitButton.frame.size.height * 0.3;
    //self.submitButton.layer.borderColor = UIColorFromRGB(0xA4AAB3).CGColor;
    //self.submitButton.layer.borderWidth = 1.5;
    self.submitButton.titleLabel.font = [UIFont nun_boldFontWithSize:self.submitButton.frame.size.height * 0.45];
